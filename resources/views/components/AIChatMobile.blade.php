    ...
    <div class="relative w-full h-full">
        ...
        <div class="relative p-2 h-full flex flex-col">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="pop-chat-mobile">
            ...
            <div class="flex flex-col flex-1 p-4 md:p-5 overflow-hidden">
                <div id="chat-box-silva" class="flex flex-col space-y-4 overflow-y-auto flex-1">
                    <!-- Chat Sambutan -->
                ...
                <!-- Form input -->
                <form id="chat-form-silva" class="flex items-center space-x-2 mt-10">
                    ...
                    <input type="text" name="chat" id="chat-input-silva" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Type your message here" required>
