<div class="sticky top-4 overflow-y-auto sidebar section-title py-5 px-5 sm:hidden lg:block hidden z-20" style="width: 320px">
    ...
    <div class="borderProfile2 title flex items-center gap-4 dark:text-white hover:text-gray-900 text-gray-900 font-medium text-lg hover:bg-gray-200 dark:hover:bg-gray-500 dark:hover:text-white py-4 px-5">
      ...
      <a class="text-md" href="/riwayat-transaksi">Riwayat Transaksi</a>
    </div> 
    <div class="borderProfile2 title flex items-center gap-4 dark:text-white hover:text-gray-900 text-gray-900 font-medium text-lg hover:bg-gray-200 dark:hover:bg-gray-500 dark:hover:text-white py-4 px-5">
      ...
      <a class="text-md" href="/pengaturan">Pengaturan</a>
    </div> 
    ...
    <div class="borderProfile2 title flex items-center gap-4 text-red-500 font-medium text-lg py-3 px-5 hover:bg-gray-200 dark:hover:bg-gray-500">
      ...
      <a class="text-md" href="/logout">Keluar</a>
    </div>
  </div>