    ...
    <section class="secPrim bg-white dark:bg-gray-900 bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern.svg')] dark:bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern-dark.svg')]">
      <div class="parnt mx-auto max-w-screen-xl gap-3 flex">
        <div class="sticky top-4 overflow-y-auto sidebar section-title py-5 px-5 sm:hidden lg:block hidden z-20" style="width: 400px">
          <div class="title dark:text-white text-grey-900 font-semibold text-3xl mb-8">Penyesuaian</div>
          <div class="borderProfile1 items-center title gap-4 flex dark:text-white hover:text-gray-900 text-gray-900 font-medium text-lg border-gray-900 dark:border-white hover:bg-gray-200 dark:hover:bg-gray-500 dark:hover:text-white py-4 px-5">
          ...
          <div class="borderProfile2 title flex items-center gap-4 text-red-500 font-medium text-lg py-3 px-5 hover:bg-gray-200 dark:hover:bg-gray-500">
        ...
        <div class="card-container z-20 section-title py-5 px-4" style="width:100%">
          <div class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 overflow-hidden px-5 py-3">
            <div class="p-4">
              ...
              <button type="button" class="px-5 py-3 text-base font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 lg:mt-5 mt-5 sm:mt-5">Simpan Perubahan</button>  
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="py-6 px-6 relative">
            ...
            <div class="daftarProfile grid grid-cols-2 gap-2" style="margin-top: 50px">
              <div class="profile w-full p-4 max-w-sm bg-white border border-gray-200 rounded-lg shadow items-center text-center sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                <a class="text-sm font-medium text-gray-500 dark:text-gray-400 text-center">Detail Profile</a>
              </div>
              <div class="profile w-full p-4 max-w-sm bg-white border border-gray-200 rounded-lg shadow items-center text-center sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                <a class="text-sm font-medium text-gray-500 dark:text-gray-400 text-center">Data Pribadi</a>
              </div>
              <div class="profile w-full p-4 max  -w-sm bg-white border border-gray-200 rounded-lg shadow items-center text-center sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                <a class="text-sm font-medium text-gray-500 dark:text-gray-400 text-center">Course Saya</a>
              </div>
              <div class="profile w-full p-4 max-w-sm bg-white border border-gray-200 rounded-lg shadow items-center text-center sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                <a class="text-sm font-medium text-gray-500 dark:text-gray-400 text-center">Riwayat Transaksi</a>
              </div>
              <div class="profile w-full p-4 max-w-sm bg-white border border-gray-200 rounded-lg shadow items-center text-center sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                <a class="text-sm font-medium text-gray-500 dark:text-gray-400 text-center">Pengaturan Lanjut</a>
              </div>
            </div>
        </div>
    </div>
