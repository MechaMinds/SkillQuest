    ...
    <div class="flex flex-col lg:flex-row gap-6 px-5 py-5">
        ...
        <div class="flex-1 flex flex-col gap-6">
            ...
            <div class="flex-1 overflow-auto">
                ...
                <button id="loadingButton" disabled type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 inline-flex items-center hidden">
    ...
    <script>
        ...
        function runCode() {
            ...
            .then(data => {
                ...
                output.textContent = "Hasil: " + rawOutput + "\n" + outputMessage;

                // Memberi warna merah jika jawaban salah, dan hijau jika benar
                output.style.color = data.isCorrect ? "green" : "red";
            })
            .catch(error => {
