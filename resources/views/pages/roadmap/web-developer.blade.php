        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 grid gap-3">
            ...
            <div class="section-title text-sm font-medium text-left text-gray-500 dark:text-gray-400 ">
                <ul class="flex flex-wrap -mb-px">
                    <li class="me-2">
                        <a href="#" class="inline-block p-4 text-blue-600 border-b-2 border-blue-600 rounded-t-lg active dark:text-blue-500 dark:border-blue-500" aria-current="page">Front-End</a>
                    </li>
                    <li class="me-2">
                        <a href="#" class="inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300">Back-End</a>
                    </li>
                </ul>
                <!-- Front-End Section -->
                <div class="grid lg:grid-cols-3 gap-1 md:grid-cols-2 sm:grid-cols-2">
                    ...
                    <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mt-10">
                        ...
                        <div class="p-5">
                            ...
                            <div class="mb-4 flex flex-wrap gap-4">
                                ...
                                <p class="flex flex-wrap gap-2">
                                  <svg class="w-5 h-5" viewBox="0 0 226 180" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M203.401 0C209.651 0 214.701 5.02734 214.701 11.25V168.75C214.701 174.973 209.651 180 203.401 180C197.15 180 192.101 174.973 192.101 168.75V11.25C192.101 5.02734 197.15 0 203.401 0ZM158.201 33.75C164.451 33.75 169.501 38.7773 169.501 45V168.75C169.501 174.973 164.451 180 158.201 180C151.95 180 146.901 174.973 146.901 168.75V45C146.901 38.7773 151.95 33.75 158.201 33.75ZM124.301 78.75V168.75C124.301 174.973 119.251 180 113.001 180C106.75 180 101.701 174.973 101.701 168.75V78.75C101.701 72.5273 106.75 67.5 113.001 67.5C119.251 67.5 124.301 72.5273 124.301 78.75ZM67.8008 101.25C74.0511 101.25 79.1008 106.277 79.1008 112.5V168.75C79.1008 174.973 74.0511 180 67.8008 180C61.5505 180 56.5008 174.973 56.5008 168.75V112.5C56.5008 106.277 61.5505 101.25 67.8008 101.25ZM33.9008 146.25V168.75C33.9008 174.973 28.8511 180 22.6008 180C16.3505 180 11.3008 174.973 11.3008 168.75V146.25C11.3008 140.027 16.3505 135 22.6008 135C28.8511 135 33.9008 140.027 33.9008 146.25Z" fill="#146FFE"/>
                                    <g clip-path="url(#clip0_3203_26019)">
                                    <path d="M203.401 0C209.651 0 214.701 5.02734 214.701 11.25V168.75C214.701 174.973 209.651 180 203.401 180C197.15 180 192.101 174.973 192.101 168.75V11.25C192.101 5.02734 197.15 0 203.401 0ZM158.201 33.75C164.451 33.75 169.501 38.7773 169.501 45V168.75C169.501 174.973 164.451 180 158.201 180C151.95 180 146.901 174.973 146.901 168.75V45C146.901 38.7773 151.95 33.75 158.201 33.75ZM124.301 78.75V168.75C124.301 174.973 119.251 180 113.001 180C106.75 180 101.701 174.973 101.701 168.75V78.75C101.701 72.5273 106.75 67.5 113.001 67.5C119.251 67.5 124.301 72.5273 124.301 78.75ZM67.8008 101.25C74.0511 101.25 79.1008 106.277 79.1008 112.5V168.75C79.1008 174.973 74.0511 180 67.8008 180C61.5505 180 56.5008 174.973 56.5008 168.75V112.5C56.5008 106.277 61.5505 101.25 67.8008 101.25ZM33.9008 146.25V168.75C33.9008 174.973 28.8511 180 22.6008 180C16.3505 180 11.3008 174.973 11.3008 168.75V146.25C11.3008 140.027 16.3505 135 22.6008 135C28.8511 135 33.9008 140.027 33.9008 146.25Z" fill="#464646"/>
                                    </g>
                                    <defs>
